...
complete_domain_schema_dict = {
    ...
    # adding logic for PCORnet updates v7
    'pro_cm_v7': {
        'PRO_CODE': T.StringType(),
        'PRO_CM_ID': T.StringType(),
        'PATID': T.StringType(),
        'ENCOUNTERID': T.StringType(),
        'PRO_DATE': T.DateType(),
        ...
        'PRO_ITEM_FULLNAME': T.StringType(),
        'PRO_ITEM_TEXT': T.StringType(),
        'PRO_MEASURE_LOINC': T.StringType(), ## added here for ingest but future step in pipeline will select PRO_CODE instead of this column
        'PRO_ITEM_LOINC': T.StringType(),    ## added here for ingest but future step in pipeline will select PRO_CODE instead of this column
...
# Required columns for PCORnet v7 version of pro_cm
required_domain_schema_dict["pro_cm_v7"] = {
    "PRO_CODE": "string",
    "PRO_FULLNAME": "string",
    "PRO_NAME": "string",
    "PRO_SEQ": "string",
