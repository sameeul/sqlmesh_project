...
def entrypoint(context: ExecutionContext, **kwargs):
    df = context.table("pcornet.step01_parsed_obs_clin")
    required_cols = list(required_domain_schema_dict["obs_clin"].keys())
    required_cols_v = list(required_domain_schema_dict["obs_clin_5.0"].keys())
