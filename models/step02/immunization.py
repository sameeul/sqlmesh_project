...
@model(
    ...
    tags=["step02"],
    columns={
        "immunizationid": "bigint",
        "patid": "bigint",
        "encounterid": "bigint",
        "proceduresid": "bigint",
        "vx_providerid": "bigint",
        "vx_record_date": "date",
        "vx_admin_date": "date",
        "vx_code_type": "string",
        "vx_code": "string",
...
def entrypoint(context: ExecutionContext, **kwargs):
    table_name = context.table("pcornet.step01_parsed_immunization")
    df = context.spark.table(table_name)
    required_cols = required_domain_schema_dict["immunization"]
