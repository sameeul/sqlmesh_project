MODEL (
  name pcornet.step04_domain_mapping_condition_era,
  kind FULL,
  dialect spark,
  tags ['step04'],
);
...
(
	...
	FROM pcornet.step04_domain_mapping_condition_occurrence co
...
GROUP BY person_id, condition_concept_id, era_end_date, data_partner_id
