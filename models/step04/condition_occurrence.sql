...
SELECT 
    ...
    FROM (
        ...
        , COALESCE(CAST(condition_start_datetime AS string), '')
        , COALESCE(condition_end_date, '')
        , COALESCE(CAST(condition_end_datetime AS string), '')
