...
@model(
    ...
    columns={
        ...
        "data_partner_id": "int",
        "mapped_medadmin_type": "string",
        "MEDADMIN_START_DATETIME": "timestamp",
        "MEDADMIN_STOP_DATETIME": "timestamp",
    },
)
def entrypoint(context: ExecutionContext, **kwargs):
    ...
    df = create_datetime_col(
        df, "medadmin_start_date", "medadmin_start_time", "MEDADMIN_START_DATETIME"
    )
    df = create_datetime_col(
        df, "medadmin_stop_date", "medadmin_stop_time", "MEDADMIN_STOP_DATETIME"
    )
    df = add_mapped_vocab_code_col(
        df, mapping_df, "MED_ADMIN", "medadmin_type", "mapped_medadmin_type"
    )
