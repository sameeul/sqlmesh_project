...
@model(
    ...
    columns={
        ...
        "PRO_MEASURE_SCORE": "string",
        "PRO_MEASURE_THETA": "string",
        "PRO_MEASURE_SCALED_TSCORE": "string",
        "PRO_MEASURE_STANDARD_ERROR": "string",
        "PRO_MEASURE_COUNT_SCORED": "string",
