...
WITH site_codes_to_source_concept_mapping AS (
    SELECT DISTINCT
        ...
        LEFT JOIN pcornet.aux_concept c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM pcornet.step03_prepared_procedures p
        LEFT JOIN pcornet.aux_concept c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM pcornet.step03_prepared_condition cd
        LEFT JOIN pcornet.aux_concept c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM pcornet.step03_prepared_death_cause dt
        LEFT JOIN pcornet.aux_concept c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM pcornet.step03_prepared_lab_result_cm l
        LEFT JOIN pcornet.aux_concept c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM pcornet.step03_prepared_dispensing dx
        LEFT JOIN pcornet.aux_concept c
    ...
    SELECT DISTINCT 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM pcornet.step03_prepared_obs_clin o
        LEFT JOIN pcornet.aux_concept c
    ...
    select 
        ...
        , c.valid_end_date              AS source_valid_end_date
        , c.invalid_reason              AS source_invalid_reason
        FROM pcornet.step03_prepared_obs_gen ob
        LEFT JOIN pcornet.aux_concept c
