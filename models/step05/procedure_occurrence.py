...
@model(
    ...
    dialect="spark",
    tags=["step05"],
    columns={"procedure_occurrence_id_51_bit": "bigint", "hashed_id": "string", "collision_bits": "int"},
)
def entrypoint(context: ExecutionContext, **kwargs):
    df = context.spark.table(context.table("pcornet.step04_domain_mapping_procedure_occurrence"))
