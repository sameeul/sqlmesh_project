...
@model(
    ...
    dialect="spark",
    tags=["step05"],
    columns={"drug_exposure_id_51_bit": "bigint", "hashed_id": "string", "collision_bits": "int"},
)
def entrypoint(context: ExecutionContext, **kwargs):
    df = context.spark.table(context.table("pcornet.step04_domain_mapping_drug_exposure"))
