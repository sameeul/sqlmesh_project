MODEL (
  name pcornet.step06_id_generation_visit_occurrence,
  kind FULL,
  dialect spark,
  tags ['step06'],
);
...
WITH join_conflict_id AS (
    ...
    FROM pcornet.step04_domain_mapping_visit_occurrence m
    LEFT JOIN pcornet.step05_pkey_collision_lookup_visit_occurrence lookup
