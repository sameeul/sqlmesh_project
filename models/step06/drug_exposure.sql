MODEL (
  name pcornet.step06_id_generation_drug_exposure,
  kind FULL,
  dialect spark,
  tags ['step06'],
);
...
WITH join_conflict_id AS (
    ...
    FROM pcornet.step04_domain_mapping_drug_exposure m
    LEFT JOIN pcornet.step05_pkey_collision_lookup_drug_exposure lookup
