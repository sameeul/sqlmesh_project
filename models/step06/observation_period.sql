MODEL (
  name pcornet.step06_id_generation_observation_period,
  kind FULL,
  dialect spark,
  tags ['step06'],
);
...
WITH join_conflict_id AS (
    ...
    FROM pcornet.step04_domain_mapping_observation_period m
    LEFT JOIN pcornet.step05_pkey_collision_lookup_observation_period lookup
