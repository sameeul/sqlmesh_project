MODEL (
  name pcornet.step06_id_generation_procedure_occurrence,
  kind FULL,
  dialect spark,
  tags ['step06'],
);
...
WITH join_conflict_id AS (
    ...
    FROM pcornet.step04_domain_mapping_procedure_occurrence m
    LEFT JOIN pcornet.step05_pkey_collision_lookup_procedure_occurrence lookup
