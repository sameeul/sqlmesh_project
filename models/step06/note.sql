MODEL (
  name pcornet.step06_id_generation_note,
  kind FULL,
  dialect spark,
  tags ['step06'],
);
...
WITH join_conflict_id AS (
    ...
    FROM pcornet.step04_domain_mapping_note m
    LEFT JOIN pcornet.step05_pkey_collision_lookup_note lookup
        ON m.note_id_51_bit = lookup.note_id_51_bit
...
FROM global_id
LEFT JOIN pcornet.step06_id_generation_person p
