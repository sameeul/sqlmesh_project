MODEL (
  name pcornet.step06_id_generation_device_exposure,
  kind FULL,
  dialect spark,
  tags ['step06'],
);
...
WITH join_conflict_id AS (
    ...
    FROM pcornet.step04_domain_mapping_device_exposure m
    LEFT JOIN pcornet.step05_pkey_collision_lookup_device_exposure lookup
