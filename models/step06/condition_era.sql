MODEL (
  name pcornet.step06_id_generation_condition_era,
  kind FULL,
  dialect spark,
  tags ['step06'],
);
...
WITH join_conflict_id AS (
    ...
    FROM pcornet.step04_domain_mapping_condition_era m
    LEFT JOIN pcornet.step05_pkey_collision_lookup_condition_era lookup
